...
//	User getUser(String userName);
	@Insert("INSERT INTO orderinfo(orderName,certifitype,certifiNumber,sex,birthday,phonenumber,email) VALUES(#{orderinfo.orderName},#{orderinfo.certifitype},#{orderinfo.certifiNumber},#{orderinfo.sex},#{orderinfo.birthday},#{orderinfo.phonenumber},#{orderinfo.email})")
